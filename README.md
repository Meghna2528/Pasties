...
The installer checks for a full JDK (`java` + `jpackage`) and Maven. If either is missing, it prompts for a JDK path or asks whether to install missing Homebrew dependencies.
